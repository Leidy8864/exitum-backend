define({ "api": [
  ...
  {
    "type": "POST",
    "url": "/users/update-image/:user_id",
    "title": "POST update user image profile",
    "name": "Actualizaci_n_de_imagen_de_p_rfil",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "user_id",
            "description": "<p>ID del usuario que actualizará su imagen.</p>"
          }
        ]
      }
    },
    "examples": [
      {
        "title": "Request parameter",
        "content": "http://35.175.241.103:8081/users/update-image/1",
        "type": "json"
      }
    ],
    "group": "USER",
        ...
        "Datos requeridos": [
          {
            ...
            "optional": false,
            "field": "photo",
            "description": "<p>Nueva imagen de perfil de usuario.</p>"
          }
        ],
        "Datos retornados": [
          {
