define({ "api": [
  ...
  {
    "type": "GET",
    "url": "/challenges/toVerify?user_id=ID&page=IDD",
    "title": "GET list to verify",
    "name": "list_to_verify",
    "group": "CHALLENGES",
    "version": "1.0.0",
    "description": "<p>Lista de retos para verificar</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
      ...
      "examples": [
        {
          "title": "Ejemplo url",
          "content": "/challenges/toVerify?user_id=12&page=1",
          "type": "querystring"
        }
      ]
    },
  ...
  },
  {
    ...
    "group": "CHALLENGES",
    "version": "1.0.0",
    "description": "<p>Verificar o dejar observaciones al el reto</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "challenge_id",
            "description": "<p>Id del reto del usuario.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "comment",
            "description": "<p>Comentario de observación.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "status",
            "description": "<p>Nuevo estado del reto a evaluar ['Con observaciones', 'Verificado'].</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Request parameter",
        "content": "http://35.175.241.103:8081/events/delete/1",
        "type": "json"
      }
    ],
    "group": "EVENTS",
