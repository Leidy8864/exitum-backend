...
-- Schema exitum
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `exitum_test` DEFAULT CHARACTER SET utf8 ;
USE `exitum_test` ;

-- -----------------------------------------------------
-- Table `exitum_test`.`area`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`area` (
...
-- -----------------------------------------------------
-- Table `exitum_test`.`category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`category` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`currency`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`currency` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`country`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`country` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_country_currency1`
    ...
    REFERENCES `exitum_test`.`currency` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `exitum_test`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`user` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_user_country1`
    ...
    REFERENCES `exitum_test`.`country` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`entrepreneur`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`entrepreneur` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_emprendedor_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `exitum_test`.`user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `exitum_test`.`stage`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`stage` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`startup`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`startup` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(145) NULL DEFAULT NULL,
  ...
  CONSTRAINT `fk_startup_category1`
    ...
    REFERENCES `exitum_test`.`category` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_startup_emprendedor1`
    FOREIGN KEY (`entrepreneur_id`)
    REFERENCES `exitum_test`.`entrepreneur` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_startup_stage1`
    FOREIGN KEY (`stage_id`)
    REFERENCES `exitum_test`.`stage` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `exitum_test`.`advertisement`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`advertisement` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_advertisement_area1`
    FOREIGN KEY (`area_id`)
    REFERENCES `exitum_test`.`area` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_project_startup1`
    FOREIGN KEY (`startup_id`)
    REFERENCES `exitum_test`.`startup` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `exitum_test`.`skill`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`skill` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`advertisement_skill`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`advertisement_skill` (
  ...
  CONSTRAINT `fk_skill_has_project_project1`
    ...
    REFERENCES `exitum_test`.`advertisement` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_skill_has_project_skill1`
    FOREIGN KEY (`skill_id`)
    REFERENCES `exitum_test`.`skill` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `exitum_test`.`advice`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`advice` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`test`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`test` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`question`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`question` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_questions_certiifications1`
    FOREIGN KEY (`test_id`)
    REFERENCES `exitum_test`.`test` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `exitum_test`.`answer`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`answer` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_answers_questions1`
    ...
    REFERENCES `exitum_test`.`question` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `exitum_test`.`appointment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`appointment` (
...
-- -----------------------------------------------------
-- Table `exitum_test`.`workshop`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`workshop` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `title` VARCHAR(145) NULL DEFAULT NULL,
  `description` TEXT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`category_workshop`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`category_workshop` (
  ...
  CONSTRAINT `fk_workshop_has_category_workshop1`
    ...
    REFERENCES `exitum_test`.`workshop` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `exitum_test`.`company`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`company` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`certification`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`certification` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(145) NULL DEFAULT NULL,
  ...
  CONSTRAINT `fk_certification_company1`
    ...
    REFERENCES `exitum_test`.`company` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`employee`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`employee` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `user_id` INT(11) NOT NULL,
  `stage_id` INT(11) NOT NULL,
  `category_id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`step`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`step` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`tip`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`tip` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_tip_step1`
    FOREIGN KEY (`step_id`)
    REFERENCES `exitum_test`.`step` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `exitum_test`.`challenge`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`challenge` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `user_id` INT(11) NOT NULL,
  ...
  CONSTRAINT `fk_challenge_employee1`
    ...
    REFERENCES `exitum_test`.`employee` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`chat`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`chat` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`order`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`order` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `created_at` DATETIME NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`order_state`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`order_state` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_order_state_order1`
    ...
    REFERENCES `exitum_test`.`order` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `exitum_test`.`delivery`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`delivery` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_deliveries_order_state1`
    ...
    REFERENCES `exitum_test`.`order_state` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `exitum_test`.`department`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`department` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`university`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`university` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`education`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`education` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `description` TEXT NULL DEFAULT NULL,
  ...
  CONSTRAINT `fk_educations_universities1`
    ...
    REFERENCES `exitum_test`.`university` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `exitum_test`.`language`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`language` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`level`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`level` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`employee_language`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`employee_language` (
  `employee_id` INT(11) NOT NULL,
  ...
  CONSTRAINT `fk_employee_has_language_language1`
    ...
    REFERENCES `exitum_test`.`language` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_employee_has_language_level1`
    FOREIGN KEY (`level_id`)
    REFERENCES `exitum_test`.`level` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `exitum_test`.`employee_step`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`employee_step` (
  `employee_id` INT(11) NOT NULL,
  `step_id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`employee_test`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`employee_test` (
  `employee_id` INT(11) NOT NULL,
  `test_id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`employee_tip`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`employee_tip` (
  `tip_id` INT(11) NOT NULL,
  `employee_id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`type` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`employee_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`employee_type` (
  `employee_id` INT(11) NOT NULL,
  ...
  CONSTRAINT `fk_employee_has_employee_types_employee_types1`
    FOREIGN KEY (`type_id`)
    REFERENCES `exitum_test`.`type` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `exitum_test`.`experience`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`experience` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  INDEX `fk_experience_category1_idx` (`category_id` ASC),
  ...
  CONSTRAINT `fk_experience_user1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_experience_category1`
    FOREIGN KEY (`category_id`)
    REFERENCES `exitum_test`.`category` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `exitum_test`.`favorite`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`favorite` (
  `from_user_id` INT(11) NOT NULL,
  `to_user_id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`file`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`file` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(145) NULL DEFAULT NULL,
  ...
  CONSTRAINT `fk_file_challenge_challenge1`
    ...
    REFERENCES `exitum_test`.`challenge` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `exitum_test`.`file_tip`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`file_tip` (
  `id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`hour`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`hour` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`invitation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`invitation` (
  `advertisement_id` INT(11) NOT NULL,
  `employee_id` INT(11) NOT NULL,
  `created_at` DATETIME NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`recommendation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`recommendation` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `description` TEXT NULL DEFAULT NULL,
  `employee_id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`like`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`like` (
  `startup_id` INT(11) NOT NULL,
  ...
  CONSTRAINT `fk_like_recomendation1`
    ...
    REFERENCES `exitum_test`.`recommendation` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`meeting`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`meeting` (
  `startup_id` INT(11) NOT NULL,
  `employee_id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`message`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`message` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_messages_chat1`
    FOREIGN KEY (`chat_id`)
    REFERENCES `exitum_test`.`chat` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `exitum_test`.`notification_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`notification_type` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `type` VARCHAR(145) NULL DEFAULT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `exitum_test`.`notification`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`notification` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `user_id` INT(11) NOT NULL,
  ...
  CONSTRAINT `fk_notifications_notifications_type1`
    ...
    REFERENCES `exitum_test`.`notification_type` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `exitum_test`.`notification_setting`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`notification_setting` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `active` TINYINT(4) NULL DEFAULT NULL,
  `user_id` INT(11) NOT NULL,
  `notification_type_id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`order_detail`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`order_detail` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `advertisement_id` INT(11) NOT NULL,
  `order_id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`proposal`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`proposal` (
  `advertisement_id` INT(11) NOT NULL,
  `employee_id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`review`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`review` (
  `from_user_id` INT(11) NOT NULL,
  `to_user_id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`review_startup`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`review_startup` (
  `user_id` INT(11) NOT NULL,
  `startup_id` INT(11) NOT NULL,
  `rating` TINYINT(1) UNSIGNED NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`skill_user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`skill_user` (
  `user_id` INT(11) NOT NULL,
  `skill_id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`startup_employee_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`startup_employee_type` (
  `startup_id` INT(11) NOT NULL,
  `type_id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`startup_step`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`startup_step` (
  `startup_id` INT(11) NOT NULL,
  `step_id` INT(11) NOT NULL,
  `tip_completed` INT(11) NULL DEFAULT NULL,
  `icon_count_tip` VARCHAR(245) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`subcategory`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`subcategory` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(145) NULL DEFAULT NULL,
  `category_id` INT(11) NOT NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `exitum_test`.`team`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`team` (
  `employee_id` INT(11) NOT NULL,
  `startup_id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`tip_skill`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`tip_skill` (
  `tip_id` INT(11) NOT NULL,
  `skill_id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`token`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`token` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`unavailable`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`unavailable` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `user_id` INT(11) NOT NULL,
  `time` TIME NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `exitum_test`.`user_advice`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`user_advice` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_user_has_advice_advice1`
    ...
    REFERENCES `exitum_test`.`advice` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`user_verification_skill`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`user_verification_skill` (
  `to_user_id` INT(11) NOT NULL,
  `from_user_id` INT(11) NOT NULL,
  `skill_id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `exitum_test`.`user_workshop`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `exitum_test`.`user_workshop` (
  `user_id` INT(11) NOT NULL,
  `workshop_id` INT(11) NOT NULL,
...
-- INSERT INTO `exitum_test`.`user` (`name`, `lastname`, `email`, `password`, `provider_id`, `confirmed`, `role`, `method`, `active`, `created_at`, `country_id`, `currency_id`) 
...
INSERT INTO `exitum_test`.`skill` (`id`,`skill`) VALUES (1,'Emprendedor');
INSERT INTO `exitum_test`.`skill` (`id`,`skill`) VALUES (2,'Diseñador Ux');
INSERT INTO `exitum_test`.`skill` (`id`,`skill`) VALUES (3,'Responsable');
INSERT INTO `exitum_test`.`skill` (`id`,`skill`) VALUES (4,'Cientifico');
INSERT INTO `exitum_test`.`skill` (`id`,`skill`) VALUES (5,'Alegre');
INSERT INTO `exitum_test`.`skill` (`id`,`skill`) VALUES (6,'Desarrollador web');
INSERT INTO `exitum_test`.`skill` (`id`,`skill`) VALUES (7,'Desarrollador movil');
INSERT INTO `exitum_test`.`skill` (`id`,`skill`) VALUES (8,'JavaScript');
INSERT INTO `exitum_test`.`skill` (`id`,`skill`) VALUES (9,'NodeJS');
INSERT INTO `exitum_test`.`skill` (`id`,`skill`) VALUES (10,'PHP');
INSERT INTO `exitum_test`.`skill` (`id`,`skill`) VALUES (11,'Android');
INSERT INTO `exitum_test`.`skill` (`id`,`skill`) VALUES (12,'Java');
...
insert into `exitum_test`.`file_tip`(id, name, key_s3,tip_id) values 
...
INSERT INTO `exitum_test`.`type` (`id`, `type`) VALUES ('1', 'Hormiga');

INSERT INTO `exitum_test`.`level` (`id`, `level`) VALUES ('1', 'Basico');
INSERT INTO `exitum_test`.`level` (`id`, `level`) VALUES ('2', 'Intermedio');
INSERT INTO `exitum_test`.`level` (`id`, `level`) VALUES ('3', 'Avanzado');

INSERT INTO `exitum_test`.`university` (`university`) VALUES ('Universidad Mayor de San Marcos');
INSERT INTO `exitum_test`.`university` (`university`) VALUES ('Pontificia Universidad Católica del Perú');

INSERT INTO `exitum_test`.`company` (`name`) VALUES ('Microsoft');
INSERT INTO `exitum_test`.`company` (`name`) VALUES ('Apple');

INSERT INTO `exitum_test`.`advice` (`id`, `title`, `description`, `type`, `order`) VALUES ( '1', 'Consejo 1', 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which dont look even slightly believable.', 'employee', '1');
INSERT INTO `exitum_test`.`advice` (`id`, `title`, `description`, `type`, `order`) VALUES ( '2', 'Consejo 2', 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which dont look even slightly believable.', 'employee', '2');
INSERT INTO `exitum_test`.`advice` (`id`, `title`, `description`, `type`, `order`) VALUES ( '3', 'Consejo 3', 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which dont look even slightly believable.', 'employee', '3');
INSERT INTO `exitum_test`.`advice` (`id`, `title`, `description`, `type`, `order`) VALUES ( '4', 'Consejo 4', 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which dont look even slightly believable.', 'employee', '4');
INSERT INTO `exitum_test`.`advice` (`id`, `title`, `description`, `type`, `order`) VALUES ( '5', 'Consejo 1', 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which dont look even slightly believable.', 'startup', '1');
INSERT INTO `exitum_test`.`advice` (`id`, `title`, `description`, `type`, `order`) VALUES ( '6', 'Consejo 2', 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which dont look even slightly believable.', 'startup', '2');
INSERT INTO `exitum_test`.`advice` (`id`, `title`, `description`, `type`, `order`) VALUES ( '7', 'Consejo 3', 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which dont look even slightly believable.', 'startup', '3');
INSERT INTO `exitum_test`.`advice` (`id`, `title`, `description`, `type`, `order`) VALUES ( '8', 'Consejo 4', 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which dont look even slightly believable.', 'startup', '4');
INSERT INTO `exitum_test`.`advice` (`id`, `title`, `description`, `type`, `order`) VALUES ( '9', 'Consejo 1', 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which dont look even slightly believable.', 'entrepreneur', '1');
INSERT INTO `exitum_test`.`advice` (`id`, `title`, `description`, `type`, `order`) VALUES ('10', 'Consejo 2', 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which dont look even slightly believable.', 'entrepreneur', '2');
INSERT INTO `exitum_test`.`advice` (`id`, `title`, `description`, `type`, `order`) VALUES ('11', 'Consejo 3', 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which dont look even slightly believable.', 'entrepreneur', '3');
INSERT INTO `exitum_test`.`advice` (`id`, `title`, `description`, `type`, `order`) VALUES ('12', 'Consejo 4', 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which dont look even slightly believable.', 'entrepreneur', '4');
